	...
	*/
	public function getConnection(){
		...
		if(empty(self::$conn)){
			...
			self::$conn = new PDO("mysql={$name};user={$user};password={$pass};host={$host}");
	...
	/*
	*Salvar ou editar Registro no banco de dados 
	*/
	public static function save($pessoa){
		...
		if(empty($pessoa['id'])){
			...
			$sql  = "INSERT INTO pessoa(id,nome,endereco,bairro,telefone,email,id_cidade)
				VALLUES(:id, :nome, :endereco, :bairro, :telefone, :email, :id_cidade)";
		}else{
